 ...
 */
public class PrinterOptionItem implements Parcelable {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeList(this.colorModeList);
    ...
    public static final Creator<PrinterOptionItem> CREATOR = new Creator<PrinterOptionItem>() {
        ...
        @Override
        public PrinterOptionItem[] newArray(int size) {
            return new PrinterOptionItem[size];
        }
    };
}
